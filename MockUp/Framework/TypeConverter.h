...
/**
 Converts Edm.Time value from SDMDuration object to URI representation as NSString object.
 @param value An SDMDuration representation of an Edm.Time value.
 @return The URI representation of the given value as NSString object. 
 */
- (NSString *)convertToEdmTimeURI:(SDMDuration *)value;
