...
@interface BaseServiceObject : NSObject {
    SDMODataServiceDocument *m_serviceDocument;
}

@property (nonatomic, strong, readonly) SDMODataServiceDocument *sdmServiceDocument; ///< The SDM service document object. 
...
/**
 Returns an NSString value, representing a String value, for a given SDMODataEntry of function import response.
...
/**
 Returns an NSDate value, representing a DateTime value, for a given SDMODataEntry of function import response.
 @param anEntry The entry of the function import response.
...
/**
 Returns an NSDecimalNumber value, representing a Decimal value, for a given SDMODataEntry of function import response.
 @param anEntry The entry of the function import response.
...
/**
 Returns an NSNumber value, representing an Integer value (Byte, SByte, Int16, Int32, Int64), for a given SDMODataEntry of function import response.
 @param anEntry The entry of the function import response.
...
/**
 Returns an NSNumber value, representing a Boolean value, for a given SDMODataEntry of function import response.
 @param anEntry The entry of the function import response.
 @return The NSNumber value of the given entry.
*/
...
/**
 Returns an NSNumber value, representing a Single value, for a given SDMODataEntry of function import response.
 @param anEntry The entry of the function import response.
 @return The NSNumber value of the given entry.
*/
...
/**
 Returns an NSNumber value, representing a Double value, for a given SDMODataEntry of function import response.
 @param anEntry The entry of the function import response.
 @return The NSNumber value of the given entry.
*/
...
/**
 Returns an NSString value, representing a DateTimeOffset value, for a given SDMODataEntry of function import response.
 @param anEntry The entry of the function import response.
 @return The NSString value of the given entry.
*/
...
/**
 Returns an NSMutableData value, representing a Binary value, for a given SDMODataEntry of function import response.
 @param anEntry The entry of the function import response.
...
/**
 Returns an SDMDuration value, representing a Binary value, for a given SDMODataEntry of function import response.
 @param anEntry The entry of the function import response.
 @return The NSMutableData value of the given entry.
*/
