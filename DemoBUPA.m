...
-(void)createBUPAS
{
    ...
    temp1.Email.LongURL = @"info@scheer-management.com";
    temp1.Website.LongURL = @"http://www.scheer-management.com/nl/";
    temp1.Address.GeoCode.Latitude = @"51.981230";
    temp1.Address.GeoCode.Longitude = @"5.093582";
    ...
    temp2.Email.LongURL = @"info@nl4b.com";
    temp2.Website.LongURL = @"http://www.nl4b.nl/";
    temp2.Address.GeoCode.Latitude = @"52.296871";
    temp2.Address.GeoCode.Longitude = @"5.252835";
    ...
    temp3.Email.LongURL = @"info@sap.com";
    temp3.Website.LongURL = @"http://www.sap.nl";
    temp3.Address.GeoCode.Latitude = @"51.712427";
    temp3.Address.GeoCode.Longitude = @"5.339744";
    ...
    temp4.Email.LongURL = @"info@arisgebruikers.nl";
    temp4.Website.LongURL = @"http://www.arisgebruikers.nl";
    temp4.Address.GeoCode.Latitude = @"51.946419";
    temp4.Address.GeoCode.Longitude = @"5.205779";
    ...
    temp5.Email.LongURL = @"info@e2ebridge.com";
    temp5.Website.LongURL = @"http://www.e2ebridge.com/";
    temp5.Address.GeoCode.Latitude = @"47.552910";
    temp5.Address.GeoCode.Longitude = @"7.596393";
...
-(void)createDemoContacts
{
    ...
    contact1.Email.LongURL = @"j.degroot@info.nl";
    ...
    contact2.Email.LongURL = @"e.dezwart@info.com";
